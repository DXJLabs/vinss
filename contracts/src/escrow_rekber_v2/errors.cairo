pub const INVALID_ACTION: felt252 = 'BAD_REKBER_V2_ACTION';
pub const INVALID_CALLDATA: felt252 = 'BAD_REKBER_V2_DATA';
pub const ZERO_CUSTODY: felt252 = 'ZERO_CUSTODY_COMMIT';
pub const ZERO_COMMITMENT: felt252 = 'ZERO_V2_COMMITMENT';
pub const DUPLICATE_COMMITMENT: felt252 = 'DUPLICATE_V2_COMMIT';
